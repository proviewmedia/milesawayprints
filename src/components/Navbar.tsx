      ...
      <nav className="bg-paper border-b border-border">
        <div className="max-w-[1400px] mx-auto px-6 py-3 flex items-center justify-between gap-6">
          ...
          <ul className="hidden md:flex items-center gap-8">
            ...
            <li>
              <Link href="/prints/golf" className="text-[15px] font-normal text-ink hover:opacity-60 transition-opacity">
                Custom
              </Link>
            </li>
            <li>
        ...
        {mobileOpen && (
          <div className="md:hidden bg-paper border-t border-border px-6 py-5 space-y-4">
            ...
            <Link href="/prints/golf" className="block text-base font-normal text-ink" onClick={() => setMobileOpen(false)}>
              Custom
            </Link>
